...
def get_module_for_descriptor(user, request, descriptor, field_data_cache, course_id,
    ...
    print "Track function: ", track_function

    xqueue_callback_url_prefix = get_xqueue_callback_url_prefix(request)


    # print "Xqueue callback url prefix: ", xqueue_callback_url_prefix, user, descriptor, field_data_cache, course_id, track_function, xqueue_callback_url_prefix, position, wrap_xmodule_display, grade_bucket_type, static_asset_path
...
def get_module_for_descriptor_internal(user, descriptor, field_data_cache, course_id,
    ...
    # print "ALSDJFASDJFLJASLDFJLASJDFLJLASDJFLAJSDLFLKJALSDJFLAJSDLFJALSDFJLKASDJFL"
